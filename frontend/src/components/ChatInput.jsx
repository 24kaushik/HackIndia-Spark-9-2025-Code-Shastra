...
const ChatInput = ({ onSend }) => {
  ...
  return (
    <motion.div 
      className="flex items-center gap-3 p-2 rounded-xl backdrop-blur-md bg-white/10 border border-gray-200/20 shadow-lg"
    ...
    >
      ...
      >
        <input
          ...
          className="w-full px-3 bg-transparent outline-none text-lg text-white placeholder:text-gray-400"
