...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("http://localhost:3000/api/v0/auth/user/register", {
        method: "POST",
        headers: {
      ...
      >
        <div className="p-8">
          ...
          >
            ...
            <motion.div variants={itemVariants} className="mb-6 relative">
              <FaPhone className="absolute top-1/2 left-3 transform -translate-y-1/2 text-purple-500" />
              <input
                type="tel"
                name="phone"
                placeholder="Phone"
